...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    if (isset($_POST['delete-withlist-submit'])){
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="qty d-flex pt-2">
                                    ...
                                    <form method="post">
                                        ...
                                        <button type="submit" name="delete-withlist-submit" class="btn font-baloo text-danger pl-0 pr-3 border-right">Delete</button>
                                    </form>
