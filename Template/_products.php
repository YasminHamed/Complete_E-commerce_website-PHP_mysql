        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <form class="form-row pt-4 font-size-16 font-baloo" method="post">
                        <input type="hidden" name="item_id" value="<?php echo $item['item_id'] ?? '1'; ?>">
                        <input type="hidden" name="user_id" value="<?php echo 1; ?>">
                        <?php
                            if (in_array($item['item_id'], $in_cart ?? [])){
                                echo '<button type="submit" disabled class="col btn btn-success form-control">In the Cart</button>';
                            }else{
                                echo '<button type="submit" name="top_sale_submit" class="col btn btn-warning form-control">Add to Cart</button>';
                            }
                        ?>
                    </form>
                </div>
                ...
                <!---    product price       -->
                    <table class="my-3">
                        ...
                        <tr class="font-rale font-size-14">
                            <td>You Save:</td>
                            <td><span class="font-size-16 text-danger">+40% OFF</span></td>
                        </tr>
                    </table>
                <!---    !product price       -->
